...
copy /y \\nas\SPECTRUM\!RETRO\zDevStudio\NMI\v19\.prueba\prueba f:\bin\prueba
copy /y \\nas\SPECTRUM\!RETRO\zDevStudio\NMI\v19\.prueba\prueba2 f:\bin\prueba2
copy /y \\nas\SPECTRUM\!RETRO\zDevStudio\NMI\v19\.prueba\prueba.tap f:\prueba.tap
